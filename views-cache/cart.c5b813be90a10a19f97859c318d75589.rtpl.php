                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remove this item" class="remove" href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">X</a> <!-- remove todos -->
                                        </td>
                                        ...
                                        <td class="product-price">
                                            <span class="amount">R$<?php echo formatPrice($value1["vlprice"]); ?></span> <!-- Preço unitário! -->
                                        </td>

                                        <td class="product-quantity">
                                            <div class="quantity buttons_added">
                                                <input type="button" class="minus" value="-" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/minus'"> <!-- removendo unitário! -->
                                                ...
                                                <input type="button" class="plus" value="+" onclick="window.location.href = '/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add'"> <!-- adicionar unitário! -->
                                            </div>
                                        </td>

                                        <td class="product-subtotal">
                                            <span class="amount">R$<?php echo formatPrice($value1["vltotal"]); ?></span>  <!-- Subtotal do produto ! -->
                                        </td>
                                    </tr>
                                    <?php } ?>
