        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-bit-title text-center">
                    <h2><?php echo htmlspecialchars( $category["descategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h2> <!-- variável e coluna - dado dinâmico -->
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li><a href="<?php echo htmlspecialchars( $value1["link"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["page"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>  <!-- numero da página dado dinâmico -->
                        <?php } ?>
